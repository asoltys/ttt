...
timeLine = {
		...
		success: function(regions) {
			...
			$.each(timeLine.regions, function(key, value) {
				if(timeLine.regions[key].NameE != 'All'){
					html += "<option value='" + timeLine.regions[key].NameShort + "'>" + timeLine.regions[key].NameE + "</option>"
				};
			});
			html += "</select>";
			$("#areaNav").append(html);
		...
		success: function(branches) {
			...
			$.each(timeLine.branches, function(key, value) {
				if(timeLine.branches[key].NameE != 'All'){
					html += "<option value='" + timeLine.branches[key].NameShort + "'>" + timeLine.branches[key].NameE + "</option>"
				};
			});
			html += "</select>";
	...
	projectContainer : function () {
		...
		$.each(timeLine.initiatives, function(key, value) {
			...
			html += "<div class='projectRow' id='p" + timeLine.initiatives[key].ID + "'>" + eval("timeLine.initiatives[key].Name".concat(lang.toUpperCase())) + " (" + timeLine.initiatives[key].ID + ")</div>";
