...
timeLine = {
	...
	areaNav : function () {
		...
		success: function(regions) {
			...
			$.each(timeLine.regions, function(key, value) {
				html += "<option value=''>" + timeLine.regions[key].NameE + "</option>"
			});
			html += "</select>";
			$("#areaNav").append(html);
		}});
	...
	branchNav : function () {
		...
		success: function(branches) {
			...
			$.each(timeLine.branches, function(key, value) {
				html += "<option value=''>" + timeLine.branches[key].NameE + "</option>"
			});
			html += "</select>";
	...
	projectContainer : function () {
		...
		html += "<div class='projectGroupRow' id='projectGroupRow3'>There will be significant changes to the way that an employee does their work. <a href='#' style='color:#ffffff;'>Hide</a></div>";
		html += "<div class='projectGroupRow' id='projectGroupRow2'>There will be some changes to the way that an employee does their work. <a href='#' style='color:#000000;'>Hide</a></div>";
		html += "<div class='projectGroupRow' id='projectGroupRow1'>There will be minimal changes to the way that an employee does their work. <a href='#' style='color:#ffffff;'>Hide</a></div>";
		html += "<div class='projectGroupRow' id='projectGroupRow0'>There will be no changes to the way that an employee does their work. <a href='#' style='color:#ffffff;'>Hide</a></div>";
	...
	timeLineContainer : function () {
		...
		html += "<div class='timeLineGroupRow' style='width:" + timeLine.widthMonth * timeLine.totalMonth() + "px;'></div>";
		html += "<div class='timeLineGroupRow' style='width:" + timeLine.widthMonth * timeLine.totalMonth() + "px;'></div>";
		html += "<div class='timeLineGroupRow' style='width:" + timeLine.widthMonth * timeLine.totalMonth() + "px;'></div>";
		html += "<div class='timeLineGroupRow' style='width:" + timeLine.widthMonth * timeLine.totalMonth() + "px;'></div>";
...
$(document).ready(function() {
	...
	$('body').on("change", "#areaSelect", timeLine.changeArea);
